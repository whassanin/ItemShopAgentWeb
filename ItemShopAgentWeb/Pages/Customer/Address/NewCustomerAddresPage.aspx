<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="NewCustomerAddresPage.aspx.cs" Inherits="ItemShopAgentWeb.Pages.Customer.Address.NewCustomerAddresPage" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="MainContent">
    <table id="addresstable" runat="server">
        ...
        <tfoot>
            <tr>
                <td colspan="2">
                    <asp:Button ID="Savebtn" runat="server" OnClick="Savebtn_Click" Text="Save Address" Width="700px"/>
                </td>
            </tr>
        </tfoot>
    </table>
