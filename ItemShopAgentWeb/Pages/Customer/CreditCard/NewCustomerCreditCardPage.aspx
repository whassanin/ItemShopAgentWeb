<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="NewCustomerCreditCardPage.aspx.cs" Inherits="ItemShopAgentWeb.Pages.Customer.CreditCard.NewCustomerCreditCardPage" %>
...
<asp:Content ID="Content1" runat="server" contentplaceholderid="MainContent">
    <table runat="server" id="CreditCardtable">
        ...
        <tfoot>
            <tr>
                <td colspan="2">
                    <asp:Button runat="server" ID="Savebtn" Text="Save Credit Card" Width="550px" />
                </td>
            </tr>
        </tfoot>
    </table>
